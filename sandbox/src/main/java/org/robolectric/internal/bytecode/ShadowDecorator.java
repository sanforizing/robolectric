...
public class ShadowDecorator implements ClassInstrumentor.Decorator {
  ...
  public void decorate(MutableClass mutableClass) {
    ...
    mutableClass.addField(0, new FieldNode(Opcodes.ACC_PUBLIC | Opcodes.ACC_SYNTHETIC,
  ...
  private void addRoboGetDataMethod(MutableClass mutableClass) {
    MethodNode initMethodNode = new MethodNode(Opcodes.ACC_PUBLIC | Opcodes.ACC_SYNTHETIC, ShadowConstants.GET_ROBO_DATA_METHOD_NAME, GET_ROBO_DATA_SIGNATURE, null, null);
